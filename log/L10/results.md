...
| FUP-DS-10  | **Re-apply iot.endpoint live.** Requires sending a Deregister, clearing m_location, then a fresh Register with the new ep= query. Owner: registration FSM. |
