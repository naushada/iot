...
| FUP-DS-11  | **Re-apply iot.server.uri live.** Requires tearing down the existing UDP/DTLS connection to the old DM server and reconnecting to the new address. Owner: UDPAdapter / DTLSAdapter. |
