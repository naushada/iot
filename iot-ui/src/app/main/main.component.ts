...
export class MainComponent {
  ...
  menus = [
    ...
    { id: 'wan',       label: 'WAN',       svg: 'assets/icons/wan.svg',
      children: [{id:'wifi',label:'WiFi Config'},{id:'scan',label:'Scan Results'},{id:'priority',label:'Priority'},{id:'cellular',label:'Cellular'}] },
    { id: 'sensors',   label: 'Sensors',   svg: 'assets/icons/dashboard.svg',
